...
import { ArrowLeft, Image as ImageIcon, Video as VideoIcon, Edit } from "lucide-react"
import Link from "next/link"
import { Card, CardContent } from "@/components/ui/card"

export default async function SupplierProductDetailsPage({ params }: { params: Promise<{ id: string }> }) {
