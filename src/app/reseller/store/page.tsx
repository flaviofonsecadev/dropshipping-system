  ...
  return (
    <div className="flex-1 space-y-6 p-6 md:p-8 pt-6 max-w-7xl mx-auto w-full">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-foreground">Minha Loja</h2>
          <p className="text-muted-foreground mt-1">Gerencie as configurações, aparência e integrações da sua loja.</p>
        </div>
        <Button>
